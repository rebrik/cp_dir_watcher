...
${OBJECTDIR}/_ext/1360937237/dir_watcher.o: ../src/dir_watcher.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/dir_watcher.o ../src/dir_watcher.cpp

${OBJECTDIR}/_ext/1360937237/file_watcher.o: ../src/file_watcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/file_watcher.o ../src/file_watcher.cpp

${OBJECTDIR}/dir_watcher_tst.o: dir_watcher_tst.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dir_watcher_tst.o dir_watcher_tst.cpp

${OBJECTDIR}/file_watcher_tst.o: file_watcher_tst.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file_watcher_tst.o file_watcher_tst.cpp

${OBJECTDIR}/test00.o: test00.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test00.o test00.cpp
